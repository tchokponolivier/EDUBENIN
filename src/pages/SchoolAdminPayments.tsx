...
export function SchoolAdminPayments() {
  ...
  const [activeTab, setActiveTab] = useState<"PAIEMENTS" | "CREANCES" | "DEPENSES" | "CAISSE_JOUR">("PAIEMENTS");
  const [expenses, setExpenses] = useState<any[]>([]);
  const [newExpense, setNewExpense] = useState({ title: "", amount: "", category: "Fournitures" });
  const [caisseStatus, setCaisseStatus] = useState<"OUVERTE" | "FERMEE">("OUVERTE");
